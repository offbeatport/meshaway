export function SkeletonCard() {
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-5 animate-pulse">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="h-6 w-14 rounded-md bg-zinc-700/50" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="rounded-lg border border-zinc-800 bg-zinc-900/40 p-4 animate-pulse">
      <div className="flex items-center gap-3">
        ...
        <div className="h-4 flex-1 max-w-[200px] rounded bg-zinc-700/40" />
