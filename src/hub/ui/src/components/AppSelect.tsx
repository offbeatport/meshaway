...
const SELECT_TRIGGER_CLASS =
  "flex h-10 w-full items-center justify-between gap-3 rounded-md border border-zinc-400 dark:border-zinc-700 bg-white dark:bg-zinc-900/80 pr-3 pl-3.5 text-sm text-zinc-900 dark:text-zinc-100 select-none hover:bg-zinc-50 dark:hover:bg-zinc-800/70 focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-1 focus-visible:outline-sky-500/70 data-[popup-open]:bg-zinc-50 dark:data-[popup-open]:bg-zinc-800/70";
const SELECT_POSITIONER_CLASS = "z-50 outline-none select-none";
const SELECT_POPUP_CLASS =
  "group min-w-[var(--anchor-width)] origin-[var(--transform-origin)] rounded-md bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 shadow-xl shadow-black/10 dark:shadow-black/30 outline outline-1 outline-zinc-200 dark:outline-zinc-800 transition-[transform,scale,opacity] data-[ending-style]:scale-95 data-[ending-style]:opacity-0 data-[side=none]:min-w-[calc(var(--anchor-width)+1rem)] data-[side=none]:data-[ending-style]:transition-none data-[starting-style]:scale-95 data-[starting-style]:opacity-0 data-[side=none]:data-[starting-style]:scale-100 data-[side=none]:data-[starting-style]:opacity-100 data-[side=none]:data-[starting-style]:transition-none";
